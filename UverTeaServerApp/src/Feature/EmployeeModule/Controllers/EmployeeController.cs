...
public class EmployeeController : ControllerBase
{
    ...
    /// </param>
    /// <response code="200">
    /// Returns the paginated employee records
    /// </response>
    /// <response code="401">
    ...
    [ProducesResponseType(
        typeof(PagedResult<EmployeeDetailResponseDto>),
            ...
            [FromQuery] PaginationParams paginationParams)
    {
        var result =
            await _mediator.Send(
                new GetAllEmployeesQuery(paginationParams));

        return Ok(result);
    }

    /// <summary>
    /// Searches employees using dynamic field criteria
    /// such as number, designation, and NIC.
    /// </summary>
    ...
    /// </response>
    /// <response code="403">
    /// Forbidden - requires Admin or Manager role
    /// </response>
    [Authorize(Roles = "Admin,Manager")]
    [HttpPost]
    [ProducesResponseType(
        typeof(EmployeeDetailResponseDto),
    ...
    public async Task<ActionResult<EmployeeDetailResponseDto>>
        CreateEmployee(
